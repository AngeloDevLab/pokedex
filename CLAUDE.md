...
- `css/components/` — one file per UI component (`buttons.css`, `inputs.css`, `search.css`, `cards.css`, `dialog.css`, `nav.css`, `stats.css`, `matchup.css`, `learnset.css`, `damage-calc.css`, `breeding.css`, `speed-tiers.css`), flat, no further nesting.
